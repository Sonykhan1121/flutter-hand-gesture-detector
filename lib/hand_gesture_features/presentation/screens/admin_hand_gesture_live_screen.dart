...
import '../../domain/enums/follow_object_sequence_phase.dart';
...
import '../../domain/services/follow_target_pointing_dwell_controller.dart';
...
import '../../domain/services/projected_pointing_cursor_controller.dart';
...
import '../painters/follow_pointing_cursor_painter.dart';
...
class _AdminHandGestureLiveScreenState extends State<AdminHandGestureLiveScreen>
  ...
  final _followTargetPointingDwell = FollowTargetPointingDwellController();
  final _projectedPointingCursor = ProjectedPointingCursorController();
  ...
  ProjectedPointingCursorObservation? _followPointingCursor;
  double _followPointingHoldProgress = 0;
  String? _followPointingStatus;
  ...
  void dispose() {
    ...
    _followTargetPointingDwell.clear();
